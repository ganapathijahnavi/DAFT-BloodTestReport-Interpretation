...
const styles = {
  page: { height: "100vh", display: "flex", fontFamily: "Inter" },
  sidebar: { width: 260, padding: 16 },
  newChat: { width: "100%", padding: 10, borderRadius: 8, background: "#2563eb", color: "#fff" },
  session: { padding: 10, borderRadius: 8, marginBottom: 6, cursor: "pointer" },
  chat: { flex: 1, display: "flex", flexDirection: "column" },
  messages: { flex: 1, padding: 16, overflowY: "auto" },
  message: { maxWidth: "75%", padding: 12, borderRadius: 14, marginBottom: 10 },
  pre: { margin: 0, whiteSpace: "pre-wrap" },

  inputBar: { display: "flex", padding: 12, gap: 10 },
  plus: { width: 40, height: 40, borderRadius: "50%", background: "#2563eb", color: "#fff" },
...
const light = { page: "#eef2ff", sidebar: "#fff", chat: "#f9fafb", input: "#fff", userBubble: "#2563eb", botBubble: "#e5e7eb", session: "#f3f4f6", activeSession: "#dbeafe", text: "#000" };
const dark = { page: "#020617", sidebar: "#020617", chat: "#020617", input: "#020617", userBubble: "#2563eb", botBubble: "#1e293b", session: "#020617", activeSession: "#1e293b", text: "#fff" };
